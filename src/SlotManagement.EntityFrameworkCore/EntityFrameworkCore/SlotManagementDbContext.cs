    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Slot>()
            .Property(e => e.StartInstant)
            .HasConversion(instantConverter);

        builder.Entity<Slot>()
            .Property(e => e.EndInstant)
            .HasConversion(instantConverter);
        ...
        //{
        //    b.ToTable(SlotManagementConsts.DbTablePrefix + "YourEntities", SlotManagementConsts.DbSchema);
